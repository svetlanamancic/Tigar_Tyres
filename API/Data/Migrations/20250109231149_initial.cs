        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TyreId = table.Column<string>(type: "text", nullable: true),
                    SalesRecordId = table.Column<string>(type: "text", nullable: true),
                    OperatorId = table.Column<string>(type: "text", nullable: false),
                    ModifiedFlag = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productions_AspNetUsers_ModifierId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productions_Tyres_TyreId",
                        column: x => x.TyreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    Price = table.Column<double>(type: "double precision", nullable: false),
                    DestinationMarket = table.Column<string>(type: "text", nullable: false),
                    PurchasingCompany = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_AspNetUsers_ModifierId",
                        column: x => x.ModifierId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sales_AspNetUsers_SupervisorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productions_ModifierId",
                table: "Productions",
                column: "ModifierId");
